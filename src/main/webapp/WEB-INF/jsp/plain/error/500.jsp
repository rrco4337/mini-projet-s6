...
<main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
  <section class="rounded-2xl border border-stone bg-white shadow-editorial p-8 sm:p-10 text-center">
    ...
    <h1 class="mt-3 font-serif text-6xl sm:text-7xl font-bold tracking-tight">500</h1>
    <h2 class="mt-4 text-2xl font-semibold">Erreur serveur</h2>
    <p class="mt-3 text-gray-600">Une erreur inattendue s est produite. Veuillez reessayer plus tard.</p>
    ...
    <div class="mt-8 flex flex-wrap justify-center gap-3">
      ...
      <a href="javascript:location.reload()" class="inline-flex items-center rounded-lg border border-stone px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors">Reessayer</a>
    </div>
  </section>
</main>
