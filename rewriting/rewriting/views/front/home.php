        ...
        <form method="get" action="<?= url('/') ?>">
          <div class="grid grid-cols-1 md:grid-cols-12 gap-5 items-end">
            <div class="md:col-span-8">
              ...
              <div class="flex flex-wrap gap-2">
                <?php foreach ($navCategories as $cat): ?>
                  <?php $isSelected = in_array($cat['slug'], $selectedCategorySlugs ?? []); ?>
            ...
            <div class="md:col-span-12 flex gap-2 justify-end">
              ...
              <a href="<?= url('/') ?>" class="px-4 py-2.5 rounded-lg border border-stone text-sm text-gray-700 hover:bg-gray-50 transition-colors">Reset</a>
            </div>
          </div>
        </form>
      </div>
