...
<div class="flex min-h-screen">
  ...
  <div class="w-full xl:ml-72">
    ...
    $adminSearchPlaceholder = 'Rechercher dans les archives...';
    $adminHeaderButtons = [
      ['href' => url('admin/articles/drafts'), 'label' => 'Brouillons', 'class' => 'rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50'],
